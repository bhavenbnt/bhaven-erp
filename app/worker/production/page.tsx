...
const s: Record<string, React.CSSProperties> = {
  ...
  cell: { padding: '8px 8px', display: 'flex', flexDirection: 'column', minHeight: 88 },
  ...
  todayNum: { color: '#fff', fontWeight: 700, background: '#B11F39', borderRadius: '50%', width: 26, height: 26, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 13 },
  kgBadge: { fontSize: 11, fontWeight: 700, color: '#B11F39', background: '#FDF2F4', borderRadius: 10, padding: '1px 6px', marginLeft: 'auto', border: '1px solid #F5D0D6' },
